    ...
    <>
      ...
      <main className="bg-white md:p-20 px-6 py-10 ">
        <div className="flex flex-col items-start gap-10 md:flex-row md:items-center md:gap-32 ">
          <div
            className="relative h-16 w-16 md:h-[3.8rem] md:w-[7.8rem] md:mb-72 rounded-full bg-gray-200 opacity-75 transition-transform ease-in-out duration-300 hover:scale-110 hover:translate-y-[-1px] hover:cursor-pointer flex justify-center items-center"
            onClick={() => navigate(-1)}
          >
            <FaArrowLeftLong size={18} color="#562ABD" />
          </div>
        ...
        <div className="mt-12 md:mt-20 md:px-52 md:text-[1.25rem]">
          <div dangerouslySetInnerHTML={{ __html: item?.topicDescription || "" }} />
        </div>
